...
const like = new Audio('images/like.mp3')
const win = new Audio("/images/win.mp3")
const empty = new Audio("/images/empty.wav")
...
function reset_comment() {
    comment.innerHTML = `Welcome to <img src="/images/logo.svg" alt="RGBquize">`;
}
